...
def DMHYKeywords(request, pageNum):
    ...
    if pageNum == 1:
        return render(request, 'DMHY/DMHYKeywordsFirstPage.html' , {'content':result, 'pageNum':2 , 'keyword':keyword})
    else:
        return render(request, 'DMHY/DMHYKeywords.html' ,  {'content':result,'keyword':keyword, 'pageNum':[pageNum + 1,pageNum,pageNum - 1]})
